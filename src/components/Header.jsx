...
function Header() {
  ...
  return (
    <div className="flex items-center gap-8 justify-between p-5 bg-[#000000] fixed top-0 left-0 right-0 z-50">
      <div className="flex gap-8 items-center">
      <div className="text-[24px] md:text-[32px] ml-10 font-bold">
  ReelTime
</div>
